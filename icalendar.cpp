...
// C APIs {
size_t timestamp_s_to_icalendarlib_str(const time_t timestamp_s, char *icalendarlib_str)
{
...
bool is_timestamp_s_within_any_event(const char *calendar_path, const time_t timestamp_s)
{
  ...
  char date[21];
  timestamp_s_to_icalendarlib_str(timestamp_s, date);
